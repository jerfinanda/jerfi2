...
botStart = time.time()
cl = LINE("tikus.churot@gmail.com","jhail123")
#cl = LINE("YOUR TOKEN")
...
settings = {
    ...
    "autoRead": False,
    "lang":"JP",
    "commentPost": "JHAIL BOT HADIR BUAT LIKE STATUS KAMU \n Add my owner ID http://line.me/ti/p/~@tikus___churot",
    "detectMention": True,
    "autoResponMessage": "Ngak Usah TAG!!! Gak Musim!!!",
    "responsticker": False,
    "changeGroupPicture":[],
    "notifikasi": False,
    "Sider":{},
    ...
    data = {
            ...
            "contents": {
             ...
             "hero": {
               ...
               "action": {
                 "type": "uri",
                 "uri": "https://line.me/ti/p/~tikus___churot"
                 }
               },
                   "type": "bubble",
                   "body": {
...
def sendTextTemplateMaster(to, text):
  ...
  "styles": {
    ...
    "header": {
     ...
     "aspectRatio": "20:13",
     "aspectMode": "cover",
     "url": "https://i.top4top.io/p_1647rba4q1.jpg",
     "size": "full",
     "margin": "xl"
  },
  "footer": {
      ...
      "contents": [{
          ...
          "contents": [{
              ...
              "action": {
                  "type": "uri",
                  "label": "JHAIL",
                  "uri": "http://line.me/ti/p/~@781dscco"
              }
          }, {
              "flex": 3,
              "type": "button",
...
def clBot(op):
  ...
  "contents": [
    {
      ...
      "body": {
        "contents": [
          ...
          {
            "type": "image",
        "url": "https://i.top4top.io/p_1647rba4q1.jpg", #hp
        "aspectRatio": "2:1",
        "aspectMode": "cover",
        "size": "full",
          },
  ...
  "type": "carousel"
                    ...
                    try:
                        arr = []
                        owner = "u3da54b627028c84544b6c8fe245b8ddf"
                        ...
                        ret_ += "\n╠ Version : Free v 1.1 by JhaiL_bots"
                        ret_ += "\n╠ Creator : {}".format(creator.displayName)
                        ret_ += "\n╚ Git : https://github.com/JHAIL-BOTS /sbt"
